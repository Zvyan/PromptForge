...
const I18N_DICT = {
    zh: {
        ...
        hero_desc: '内置 9 大类工程级专业提示词模板，支持 OpenAI / Codex、Claude、Gemini、Cursor、Windsurf、ZCode、DeepSeek Harness 与 Kimi (Moonshot AI)。分类清晰、参数动态校验、一键无缝接入。',
    ...
    en: {
        ...
        hero_desc: '56 production-grade templates across 9 domains with 118 ready presets. Native support for OpenAI/Codex, Claude, Gemini, Cursor, Windsurf, ZCode, DeepSeek Harness & Kimi (Moonshot AI).',
